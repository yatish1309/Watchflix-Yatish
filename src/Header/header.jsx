    ...
    <div className="header" style={{ 
      ...
      <div className="content" style={{
        ...
        <div className="Movies">
          <NavLink to="/movies" style={{color:"#FFFFFF",textDecoration:"none"}}
          onClick={()=>{handleContentClick("movies");}}
          >Movies</NavLink>
          <div style={{
            width: "24px",
            height: "3.75px",
        ...
        <div className="tvseries">
          <NavLink to="/tvseries" style={{color:"#FFFFFF",textDecoration:"none"}}
          onClick={()=>{handleContentClick("tvseries");}}
        ...
        <div className="documentries">
          <NavLink to="/documentries" style={{color:"#FFFFFF",textDecoration:"none"}}
          onClick={()=>{handleContentClick("documentries");}}
          >Documentries</NavLink>
          <div style={{
            width: "24px",
            height: "3.75px",
            flexShrink: "0",
        ...
        <div className="categories">
          <NavLink to="/categories" style={{color:"#FFFFFF",textDecoration:"none"}}
          onClick={()=>{handleContentClick("categories");}}
          >Categories</NavLink>
          <div style={{
            width: "24px",
            height: "3.75px",
